...
public class DeprecatedTeamCityAgentPlugin implements Plugin<Project> {

    @Override
    public void apply(Project project) {
        project.getLogger().warn(DEPRECATED_PLUGIN_MESSAGE, DEPRECATED_AGENT_PLUGIN_ID, AGENT_PLUGIN_ID);
        project.getPluginManager().apply(AGENT_PLUGIN_ID);
    }
}
