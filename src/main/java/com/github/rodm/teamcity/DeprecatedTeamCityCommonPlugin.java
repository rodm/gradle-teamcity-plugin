...
public class DeprecatedTeamCityCommonPlugin implements Plugin<Project> {

    @Override
    public void apply(Project project) {
        project.getLogger().warn(DEPRECATED_PLUGIN_MESSAGE, DEPRECATED_COMMON_PLUGIN_ID, COMMON_PLUGIN_ID);
        project.getPluginManager().apply(COMMON_PLUGIN_ID);
    }
}
