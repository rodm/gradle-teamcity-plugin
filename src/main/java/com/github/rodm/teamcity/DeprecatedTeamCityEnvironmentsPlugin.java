...
public class DeprecatedTeamCityEnvironmentsPlugin implements Plugin<Project> {

    @Override
    public void apply(Project project) {
        project.getLogger().warn(DEPRECATED_PLUGIN_MESSAGE, DEPRECATED_ENVIRONMENTS_PLUGIN_ID, ENVIRONMENTS_PLUGIN_ID);
