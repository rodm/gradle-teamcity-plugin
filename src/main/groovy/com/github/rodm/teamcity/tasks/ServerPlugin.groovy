...
class ServerPlugin extends AbstractPluginTask {

    @InputFiles
    final ConfigurableFileCollection server = project.objects.fileCollection()

    @InputFiles
    final ConfigurableFileCollection agent = project.objects.fileCollection()
